...
libraryDependencies += "com.ideal.linked" %% "toposoid-sentence-transformer-neo4j" % "0.6" % Test
libraryDependencies += "com.ideal.linked" %% "toposoid-feature-vectorizer" % "0.6" % Test
